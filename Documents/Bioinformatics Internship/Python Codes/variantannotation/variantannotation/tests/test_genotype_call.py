...
class TestGenCall(unittest.TestCase):
    ...
    def setUp(self):
        self.gen_call = [
                          ['GT:GQ:PL', '1/1:6:69,6,0'],
                          ['GT:AD:DP:GQ:PL', '0/1:10,3:13:87:87,0,379'],
                          ['GT:AD:DP:GQ:PL', '0/1:97,97:194:99:3469,0,3458'],
                          ['GT:AD:DP:GQ:PL', '1/1:0,267:267:99:11155,803,0'],
                          ['GT:AD:DP:GQ:PL', '1/2:23,48,156:227:99:3983,2789,3888,475,0,411'],
                          ['GT:AD:DP:GQ:PL', '1/2:29,158,85:272:99:6336,1149,2024,4122,0,6055']
                        ]
